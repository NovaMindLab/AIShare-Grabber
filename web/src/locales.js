...
export const messages = {
  ...
  en: {
    ...
    download: {
      ...
      subtitle: "Fast, private, and ad-free open-source photo sync and local AI gallery.",
      pc_title: "ShareCLIP Desktop App",
      pc_meta: "For Windows 10 / 11 (64-bit)",
      pc_desc: "Includes local AI search engine, 4K Lightbox gallery, and smart deduplication.",
      pc_btn: "Download for Windows (.exe)",
      android_title: "ShareCLIP Android Companion",
      android_meta: "For Android 8.0+",
      android_desc: "Built with Flutter. Supports QR scanning, Wi-Fi Direct, and background sync.",
