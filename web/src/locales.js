...
export const messages = {
  zh: {
    ...
    macModal: {
      title: "选择适合您 Mac 的版本",
      subtitle: "ShareCLIP 原生支持 Apple Silicon 与 Intel 双架构，请选择匹配您机型的芯片版本",
      armTitle: "Apple Silicon (M 系列芯片)",
      armBadge: "推荐 • M1 / M2 / M3 / M4",
      armDesc: "适用于 2020 年及以后发布的配备 Apple M 系列芯片的 Mac 电脑",
      armBtnDmg: "下载 Apple Silicon DMG 安装包",
      armBtnZip: "下载 ZIP 免安装包",
      intelTitle: "Intel 酷睿芯片 (x86_64)",
      intelBadge: "兼容 • Core i5 / i7 / i9",
      intelDesc: "适用于 2020 年及以前发布的配备 Intel 处理器或虚拟机的 Mac 电脑",
      intelBtnDmg: "下载 Intel 芯片 DMG 安装包",
      intelBtnZip: "下载 ZIP 免安装包",
      detectedBadge: "✨ 智能检测到当前设备架构",
      howToTitle: "🤔 不知道如何选择芯片版本？",
      howToDesc: "点击屏幕左上角  苹果图标 ➔「关于本机」，在弹出窗口中查看【芯片】或【处理器】信息：若含 M1/M2/M3/M4 则选 Apple Silicon，若含 Intel 则选 Intel 芯片版。"
    },
    videoSection: {
  ...
  en: {
    ...
    macModal: {
      title: "Choose macOS Architecture",
      subtitle: "ShareCLIP natively supports both Apple Silicon and Intel Macs. Please select the version that matches your device.",
      armTitle: "Apple Silicon (M-Series)",
      armBadge: "Recommended • M1 / M2 / M3 / M4",
      armDesc: "For Macs equipped with Apple M-Series chips (2020 and newer models)",
      armBtnDmg: "Download Apple Silicon DMG",
      armBtnZip: "Download ZIP Archive",
      intelTitle: "Intel Core Processor (x86_64)",
      intelBadge: "Compatible • Core i5 / i7 / i9",
      intelDesc: "For Macs equipped with Intel processors or VM environments (2020 and earlier)",
      intelBtnDmg: "Download Intel Mac DMG",
      intelBtnZip: "Download ZIP Archive",
      detectedBadge: "✨ Auto-detected for your Mac",
      howToTitle: "🤔 Not sure which architecture you have?",
      howToDesc: "Click the  Apple icon in the top left corner ➔ 'About This Mac'. If it displays 'Apple M1/M2/M3/M4', choose Apple Silicon. If it mentions 'Intel', choose Intel Mac."
    },
    videoSection: {
      badge: "OFFICIAL PROMO & DEMO",
