...
本目录收录了关于 **ShareCLIP (Image Clip)** 核心架构演进、AI 推理选型、性能量化基准与工程落地的 9 项核心调研报告与落地指南：
...
| **05** | **MobileCLIP2-S0 国外多语言发版** | 海外 20+ 语言支持、多语言 vs 单英语体积量化对比、Prompt 模板工程与温度校准 | [05_prompt_engineering_and_multilingual.md](file:///d:/AI_serach_image/image_clip_android/wiki_work/05_prompt_engineering_and_multilingual.md) |
...
| **09** | **外置 1.5MB 国际化概念词典实现** | 零体积膨胀多语言方案架构设计、核心代码实现、red vs 红色彩检索绝对一致性修复与 140+ 国家支持 | [09_international_lexicon_and_concept_aligner_implementation.md](file:///d:/AI_serach_image/image_clip_android/wiki_work/09_international_lexicon_and_concept_aligner_implementation.md) |
